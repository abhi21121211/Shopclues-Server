...
const {HomepagesportsModel} = require("../models/Mobile.model")
const {UserModel} = require("../models/User.model")

const homepagesportsRouter = Router();
...
homepagesportsRouter.put("/edit/:blogID",async(req,res)=>{
    const {title,category,content }=req.body
...
homepagesportsRouter.delete("/delete/:blogID",async(req,res)=>{
...
module.exports={homepagesportsRouter}