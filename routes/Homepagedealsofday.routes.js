...
const {HomepagedealsofdayModel} = require("../models/Mobile.model")
const {UserModel} = require("../models/User.model")

const homepagedealsofdayRouter = Router();
...
homepagedealsofdayRouter.put("/edit/:blogID",async(req,res)=>{
    const {title,category,content }=req.body
...
homepagedealsofdayRouter.delete("/delete/:blogID",async(req,res)=>{
...
module.exports={homepagedealsofdayRouter}