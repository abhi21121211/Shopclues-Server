...
const {WomenModel} = require("../models/Mobile.model")
...
womenRouter.put("/edit/:blogID",async(req,res)=>{
    const {title,category,content }=req.body
...
womenRouter.delete("/delete/:blogID",async(req,res)=>{
