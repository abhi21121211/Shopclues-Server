...
const {HomepagefestivalstoreModel} = require("../models/Mobile.model")
const {UserModel} = require("../models/User.model")

const homepagefestivalstoreRouter = Router();
...
homepagefestivalstoreRouter.put("/edit/:blogID",async(req,res)=>{
    const {title,category,content }=req.body
...
homepagefestivalstoreRouter.delete("/delete/:blogID",async(req,res)=>{
...
module.exports={homepagefestivalstoreRouter}